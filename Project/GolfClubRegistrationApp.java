...
//Golf Club member registration with GUI created by Daniel Dean Phillip for Project 2 KK14203 - Object Oriented Programming
...
class LoginPanel extends JPanel {
   ...
   public LoginPanel(JFrame frame, Login login) {
     //construct components
      ...
      message = new JLabel ("WELCOME TO THE GOLF CLUB MEMBER");
...
class RegisterPanel extends JPanel implements ActionListener{
   ...
   public RegisterPanel() {
      ...
      lbl_registration = new JLabel ("GOLF CLUB MEMBER REGISTRATION FORM");
         ...
         new ActionListener(){
            public void actionPerformed(ActionEvent e){
               ...
               if(a==JOptionPane.YES_OPTION){
                  GolfClubRegistrationApp.frame.getContentPane().removeAll();
                  GolfClubRegistrationApp.frame.getContentPane().add (new LoginPanel(GolfClubRegistrationApp.frame, GolfClubRegistrationApp.log)); 
                  GolfClubRegistrationApp.frame.pack();
                  GolfClubRegistrationApp.frame.setVisible (true);}}});
...
class AdminPanel extends JPanel {
   ...
   public AdminPanel() {
      ...
      lbl_admin = new JLabel ("         ADMIN GOLF CLUB");
...
//main program
//Program run here
public class GolfClubRegistrationApp{   
   static Login log;
   static JFrame frame;
